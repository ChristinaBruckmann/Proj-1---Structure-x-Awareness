...
colnames(Rdata) <- c('con','alpha','resp')


# Run Logistic Regression Models

R_model <- glm(Rdata$resp ~ Rdata$con + Rdata$alpha, family="binomial")
R_res<- c(R_model[["coefficients"]][["(Intercept)"]],R_model[["coefficients"]][["Rdata$con"]],R_model[["coefficients"]][["Rdata$alpha"]])
