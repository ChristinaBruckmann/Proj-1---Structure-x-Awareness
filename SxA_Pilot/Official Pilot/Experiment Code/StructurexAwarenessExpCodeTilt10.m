...
% Adjusted different parameters to increase the number of trials
% Rhythm interval reduced to 700ms
% Cue duration now 50ms
% Removed 0.2 pause between questions
% Changed display time of 'correct/Incorrect' to 0.5 instead of 1 second
% timeinfo.preqjitter changed to 0.1 0.3 and 0.5
% jittered the noise post target
%% Set-Up
...
mixinfo.nSamples = 14; % how often each point is sampled (needs to be divisible by 2, currently doesn't affect trial matrix)
...
timeinfo.rhyISI = 0.7; % rhythm interval length
timeinfo.intISI = 0.7; % interval length
% else
%     rhyISI=0.1;
%     intISI=0.1;
% end
...
timeinfo.CueDur = 0.05; % Duration of cue
...
timeinfo.preqjitter = [0.1 0.3 0.5]; % time after target before first question
