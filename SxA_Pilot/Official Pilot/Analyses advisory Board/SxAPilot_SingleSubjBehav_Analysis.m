...
function SxAPilot_SingleSubjBehav_Analysis(subj_n,plots)
cd 'C:\Users\cbruckmann\Documents\PhD Projects\Proj1 - StructurexAwareness\SxA_Pilot\Official Pilot\Data'


loadname=sprintf('PilotOfficialSxA1.1_s%i.mat',subj_n);
savename=sprintf('SxAPilot_ResultsSubject%i',subj_n);
