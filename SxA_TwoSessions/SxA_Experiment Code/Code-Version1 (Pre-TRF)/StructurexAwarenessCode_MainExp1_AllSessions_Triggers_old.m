...
pause(1)
io64(timeinfo.triggerPort, timeinfo.triggerPortAddress, 55);
...
%         end
        ...
        for b=1:mixinfo.nBlockstot
            ...
            if b<=3
                breaktext=sprintf('Block %i/%i completed. Please take a break.\n \n\n \n Wait for the experimenter to start the next block.', b,(mixinfo.nBlockstot)); % Pretend it's more blocks
            else
