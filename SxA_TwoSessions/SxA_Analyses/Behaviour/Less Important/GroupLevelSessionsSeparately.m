% Group Average Behavioural Sessions Separately
clear
clc

subjects=[101:103 105:106 108 110:111 113];
session=3; % 3=both sessions
...
for s=subjects
    if session==1
        loadname=sprintf('SxA_ResultsSubject%i_Session1.mat',s);
    elseif session==2
        loadname=sprintf('SxA_ResultsSubject%i_Session2.mat',s);
    elseif session==3
