...
cd 'Z:\el-Christina\SxA\SxA_Results\New Delta Results'
if cluster==1 && catchonly
save("NewFreq_DeltaGL_Occ_Catch",'Delta','subj','timeVec','nTrials')
elseif cluster==1 && ~catchonly
save("NewFreq_DeltaGL_Occ_All",'Delta','subj','timeVec','nTrials')
elseif cluster==2 && catchonly
save("NewFreq_DeltaGL_Cen_Catch",'Delta','subj','timeVec','nTrials')
elseif cluster==2 && ~catchonly
save("NewFreq_DeltaGL_Cen_All",'Delta','subj','timeVec','nTrials')
end