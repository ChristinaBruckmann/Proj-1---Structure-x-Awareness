...
%Fit a logistic curve for each time point and each frequency within the alpha range
% single Trial TF data (and if needed the baseline TF data) has to have alrady been calculated
clear
clc
